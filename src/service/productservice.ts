...
export class MedicineService {
  ...
  getProductsMini() {
    return Promise.resolve(this.getWaitingList().slice(0, 5));
  }

  getProductsSmall() {
    return Promise.resolve(this.getWaitingList().slice(0, 10));
  }

  getProducts() {
    return Promise.resolve(this.getWaitingList());
  }
